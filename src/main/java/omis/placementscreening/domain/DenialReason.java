 ...
 * @author Ryan Johns
 * @since OMIS 3.0 */
public interface DenialReason extends Creatable, Updatable {
	/** Gets id.
	 * @return id id. */
	Long getId();
	
	/** Gets denial category.
	 * @return denailCategory denial category. */
	DenialCategory getDenialCategory();
	...
	/** Sets denial category.
	 * @param denialCategory denial category. */
	void setDenialCategory(DenialCategory denialCategory);
