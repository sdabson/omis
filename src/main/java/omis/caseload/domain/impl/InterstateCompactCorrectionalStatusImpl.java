...
/**
 * Implementation of interstate compact correctional status.
 * 
 * @author Josh Divine
 * @version 0.1.0 (Sep 6, 2018)
 * @since OMIS 3.0
 */
public class InterstateCompactCorrectionalStatusImpl
		implements InterstateCompactCorrectionalStatus {
	 ...
	 * Constructor.
	 */
	public InterstateCompactCorrectionalStatusImpl() {
	...
	public boolean equals(final Object obj) {
		...
		if (!(obj instanceof InterstateCompactCorrectionalStatus)) {
			return false;
		}
		InterstateCompactCorrectionalStatus that = 
				(InterstateCompactCorrectionalStatus) obj;
