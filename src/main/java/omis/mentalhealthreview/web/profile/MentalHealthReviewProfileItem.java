package omis.mentalhealthreview.web.profile;
...
/** Profile item for mental health review.
 * @author Ryan Johns
 * @version 0.1.0 (Apr 13, 2018)
 * @since OMIS 3.0 */
public class MentalHealthReviewProfileItem 
	extends AbstractProfileItem 
	implements ProfileItem {
	private static final long serialVersionUID = 1L;

	/** Constructor. */
	public MentalHealthReviewProfileItem(	
