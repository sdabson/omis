...
/**
 * Implementation of unit manager review.
 * 
 * @author Josh Divine
 * @version 0.1.0 (Jan 29, 2018)
 * @since OMIS 3.0
 */
public class UnitManagerReviewImpl implements UnitManagerReview {
	...
	/** 
	 * Instantiates an implementation of unit manager review. 
	 */
	public UnitManagerReviewImpl() {
		// Default constructor.
	}
	...
	public boolean equals(final Object obj) {
		...
		if (!(obj instanceof UnitManagerReview)) {
			return false;
		}
		UnitManagerReview that = (UnitManagerReview) obj;
