...
/**
 * Unit manager review document association item.
 * 
 * @author Josh Divine
 * @version 0.1.0 (Jan 29, 2018)
 * @since OMIS 3.0
 */
public class UnitManagerReviewDocumentAssociationItem {

	private UnitManagerReviewDocumentAssociation
	...
	private UnitManagerReviewItemOperation itemOperation;
	 ...
	 * 
	 */
	public UnitManagerReviewDocumentAssociationItem() {
	}

	/**
	 * Returns the unit manager review document association.
	 * 
	 * @return unit manager review document association
	 */
	public UnitManagerReviewDocumentAssociation
			getUnitManagerReviewDocumentAssociation() {
		return unitManagerReviewDocumentAssociation;
	}

	/**
	 * Sets the unit manager review document association.
	 * 
	 * @param unitManagerReviewDocumentAssociation unit manager review document 
	 * association
	 */
	public void setUnitManagerReviewDocumentAssociation(
			final UnitManagerReviewDocumentAssociation
					unitManagerReviewDocumentAssociation) {
		this.unitManagerReviewDocumentAssociation =
				unitManagerReviewDocumentAssociation;
	}
	 ...
	 */
	public UnitManagerReviewItemOperation getItemOperation() {
	...
	public void setItemOperation(
			final UnitManagerReviewItemOperation itemOperation) {
