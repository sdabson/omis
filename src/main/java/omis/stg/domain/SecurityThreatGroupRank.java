...
/**
 * Rank within a security threat group.
 * 
 * @author Stephen Abson
 * @version 0.1.0 (Jan 16, 2014)
 * @since OMIS 3.0
 */
public interface SecurityThreatGroupRank
	...
	/**
	 * Sets the security threat group
	 * @param securityThreatGroup security threat group
	 */
	void setGroup(SecurityThreatGroup securityThreatGroup);
	
	/**
	 * Returns the security threat group
