...
/**
 * Implementation of fence restriction.
 * @author Yidong Li
 * @version 0.1.0 (Aug 17, 2016)
 * @since OMIS 3.0 
 */
public class FenceRestrictionImpl implements FenceRestriction {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof FenceRestriction)) {
			return false;
		}
		
		FenceRestriction that = (FenceRestriction) obj;
