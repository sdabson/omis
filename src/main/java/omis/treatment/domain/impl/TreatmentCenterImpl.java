package omis.treatment.domain.impl;

import omis.location.domain.Location;
import omis.treatment.domain.TreatmentCenter;

/**
 * Implementation of treatment center.
 * 
 * @author Josh Divine
 * @version 0.1.0 (Jan 13, 2017)
 * @since OMIS 3.0
 */
public class TreatmentCenterImpl implements TreatmentCenter {
	...
	public boolean equals(final Object obj) {
		...
		if (!(obj instanceof TreatmentCenter)) {
			return false;
		}
		TreatmentCenter that = (TreatmentCenter) obj;
