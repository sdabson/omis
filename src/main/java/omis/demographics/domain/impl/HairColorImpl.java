...
/**
 * Implementation of hair color.
 * 
 * @author Stephen Abson
 * @version 0.1.1 (Dec 23, 2012)
 * @since OMIS 3.0
 */
public class HairColorImpl implements HairColor {
	...
	/** Instantiates a default hair color. */
	public HairColorImpl() {
		// Do nothing
	}
