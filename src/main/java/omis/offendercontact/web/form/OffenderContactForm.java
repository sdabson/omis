...
public class OffenderContactForm implements Serializable{
	...
	private Boolean residentAtMailingAddress;
	
	private Date residentAtMailingAddressEffectiveDate;
	...
	/**
	 * Sets whether resident at mailing address.
	 * 
	 * @param residentAtMailingAddress whether resident at mailing address.
	 */
	public void setResidentAtMailingAddress(
			final Boolean residentAtMailingAddress) {
		this.residentAtMailingAddress = residentAtMailingAddress;
	}
	
	/**
	 * Returns whether resident at mailing address.
	 * 
	 * @return whether resident at mailing address
	 */
	public Boolean getResidentAtMailingAddress() {
		return this.residentAtMailingAddress;
	}
	
	/**
	 * Sets effective date of residence at mailing address.
	 * 
	 * @param residentAtMailingAddressEffectiveDate effective date of residence
	 * at mailing address
	 */
	public void setResidentAtMailingAddressEffectiveDate(
			final Date residentAtMailingAddressEffectiveDate) {
		this.residentAtMailingAddressEffectiveDate
			= residentAtMailingAddressEffectiveDate;
	}
	
	/**
	 * Returns effective date of residence at mailing address.
	 * 
	 * @return effective date of residence at mailing address
	 */
	public Date getResidentAtMailingAddressEffectiveDate() {
		return this.residentAtMailingAddressEffectiveDate;
	}
