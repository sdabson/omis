 ...
 * 
 * <p>A term in which a correctional status is associated with an offender.
 * 
 * @author Jason Nelson
 * @version 0.1.0 (Nov 6, 2013)
 * @since OMIS 3.0
 */
public interface CorrectionalStatusTerm extends Creatable, Updatable,
		OffenderAssociable {
	 ...
	 * @return correctional status during term
	 */
