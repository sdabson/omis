...
/**
 * Implementation of tier level.
 * 
 * @author Stephen Abson
 * @version 0.1.0 (Dec 12, 2013)
 * @since OMIS 3.0
 */
public class TierLevelImpl
		implements TierLevel {
	...
	/** Instantiates an implementation of tier level.
	public TierLevelImpl() {
