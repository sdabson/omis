 ...
 * @since OMIS 3.0 */
public class LegacyOffenderPlacementSummaryImpl
				implements LegacyOffenderPlacementSummary {
	...
	/** Default Constructor. */
	public LegacyOffenderPlacementSummaryImpl() {
	}
	...
	public LegacyOffenderPlacementSummaryImpl(final String currentLocationReasonName, 
