...
/**
 * Parole board itinerary search form.
 *
 * @author Josh Divine
 * @version 0.1.0 (Nov 14, 2017)
 * @since OMIS 3.0
 */
public class ParoleBoardItinerarySearchForm implements Serializable {
	...
	/** Instantiates a default instance of parole board itinerary search form.*/
	public ParoleBoardItinerarySearchForm() {
		//Default constructor.
	}
