 ...
 * @since OMIS 3.0
 */
public interface FinancialAsset extends Creatable, Updatable, 
	OffenderAssociable {
	...
	/**
	 * Returns the financial asset category.
	 * 
	 * @return financial asset category
	 */
	FinancialAssetCategory getCategory();
	
	/**
	 * Sets the financial asset category.
	 * 
	 * @param category financial asset category
	 */
	void setCategory(FinancialAssetCategory category);
