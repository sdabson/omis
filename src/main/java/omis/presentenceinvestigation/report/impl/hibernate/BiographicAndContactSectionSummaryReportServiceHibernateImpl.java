...
/**
 * BiographicAndContactSectionSummaryReportServiceHibernateImpl.java
 * 
 * @author Annie Wahl
 * @author Josh Divine
...
public class 
	...
	@Override
	public List<BiographicAndContactSummary> 
			findBiographicAndContactSectionSummaryByOffender(
					final Offender offender) {
		return (List<BiographicAndContactSummary>) this.sessionFactory
				.getCurrentSession()
