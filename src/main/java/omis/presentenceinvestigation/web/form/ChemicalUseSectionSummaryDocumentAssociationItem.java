...
/**
 * ChemicalUseSectionSummaryDocumentAssociationItem.java
 * 
 ...
 *
 */
public class ChemicalUseSectionSummaryDocumentAssociationItem {
	
	private ChemicalUseSectionSummaryDocumentAssociation
	 ...
	 * 
	 */
	public ChemicalUseSectionSummaryDocumentAssociationItem() {
	}
	...
	public ChemicalUseSectionSummaryDocumentAssociation
			getChemicalUseSectionSummaryDocumentAssociation() {
		return chemicalUseSectionSummaryDocumentAssociation;
	}
	 ...
	 * ChemicalUseSectionSummaryDocumentAssociation
	 */
	public void setChemicalUseSectionSummaryDocumentAssociation(
			final ChemicalUseSectionSummaryDocumentAssociation
				chemicalUseSectionSummaryDocumentAssociation) {
		this.chemicalUseSectionSummaryDocumentAssociation =
				chemicalUseSectionSummaryDocumentAssociation;
	}
