...
/**
 * PsychologicalSectionSummaryDocumentItem.java
 * 
 ...
 *
 */
public class PsychologicalSectionSummaryDocumentItem {
	
	private PsychologicalSectionSummaryDocument psychologicalSectionSummaryDocument;
	...
	/**
	 * Default Constructor for PsychologicalSectionSummaryDocumentItem
	 */
	public PsychologicalSectionSummaryDocumentItem() {
	}

	/**
	 * Returns the psychologicalSectionSummaryDocument
	 * @return psychologicalSectionSummaryDocument -
	 * PsychologicalSectionSummaryDocument
	 */
	public PsychologicalSectionSummaryDocument
			getPsychologicalSectionSummaryDocument() {
		return psychologicalSectionSummaryDocument;
	}

	/**
	 * Sets the psychologicalSectionSummaryDocument
	 * @param psychologicalSectionSummaryDocument -
	 * PsychologicalSectionSummaryDocument
	 */
	public void setPsychologicalSectionSummaryDocument(
			final PsychologicalSectionSummaryDocument
				psychologicalSectionSummaryDocument) {
		this.psychologicalSectionSummaryDocument =
				psychologicalSectionSummaryDocument;
	}
