...
/**
 * PleaAgreementSectionSummaryAssociableDocumentItem.java
 * 
 ...
 *
 */
public class PleaAgreementSectionSummaryAssociableDocumentItem {
	
	private PleaAgreementSectionSummaryAssociableDocument
	 ...
	 * 
	 */
	public PleaAgreementSectionSummaryAssociableDocumentItem() {
	}

	/**
	 * Returns the pleaAgreementSectionSummaryAssociableDocument
	 * @return pleaAgreementSectionSummaryAssociableDocument - PleaAgreementSectionSummaryAssociableDocument
	 */
	public PleaAgreementSectionSummaryAssociableDocument
		getPleaAgreementSectionSummaryAssociableDocument() {
		return pleaAgreementSectionSummaryAssociableDocument;
	}

	/**
	 * Sets the pleaAgreementSectionSummaryAssociableDocument
	 * @param pleaAgreementSectionSummaryAssociableDocument - PleaAgreementSectionSummaryAssociableDocument
	 */
	public void setPleaAgreementSectionSummaryAssociableDocument(
			final PleaAgreementSectionSummaryAssociableDocument
				pleaAgreementSectionSummaryAssociableDocument) {
		this.pleaAgreementSectionSummaryAssociableDocument =
				pleaAgreementSectionSummaryAssociableDocument;
	}
