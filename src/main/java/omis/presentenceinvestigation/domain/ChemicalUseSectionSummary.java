...
/**
 * ChemicalUseSectionSummary.java
 * 
 ...
 *
 */
public interface ChemicalUseSectionSummary extends Creatable, Updatable {
	
	/**
	 * Returns the ID of the ChemicalUseSectionSummary
	 * @return ID
	 */
	public Long getId();
	
	/**
	 * Sets the ID of the ChemicalUseSectionSummary
	 * @param id - Long
	 */
	public void setId(Long id);
	
	/**
	 * Returns the PresentenceInvestigationRequest for the ChemicalUseSectionSummary
	...
	/**
	 * Sets the PresentenceInvestigationRequest for the ChemicalUseSectionSummary
