...
/**
 * PsychologicalSectionSummary.java
 * 
 ...
 *
 */
public interface PsychologicalSectionSummary extends Creatable, Updatable {
	
	/**
	 * Returns the ID of the PsychologicalSectionSummary
	 * @return ID
	 */
	public Long getId();
	
	/**
	 * Sets the ID of the PsychologicalSectionSummary
	 * @param id - Long
	 */
