 ...
 *
 */
public interface CircumstanceOfOffense extends Creatable, Updatable {
	
	
	/**
	 * Returns the ID of the CircumstanceOfOffense
	 * @return ID
	 */
	public Long getId();
	
	/**
	 * Sets the ID of the CircumstanceOfOffense
	 * @param id - Long
	 */
	public void setId(Long id);
	
	/**
	 * Returns the Document for the CircumstanceOfOffense
	 * @return document - Document
	 */
	public Document getDocument();
	
	/**
	 * Sets the Document for the CircumstanceOfOffense
	...
	/**
	 * Returns the Statement for the CircumstanceOfOffense
	 * @return statement - DefendantsStatement
	 */
	public DefendantsStatement getStatement();
	
	/**
	 * Sets the Statement for the CircumstanceOfOffense
	 * @param statement - DefendantsStatement
	 */
	public void setStatement(DefendantsStatement statement);
