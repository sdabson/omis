 ...
 * @since OMIS 3.0
 */
public interface ProviderExternalReferralAssociation
	...
	/**
	 * Returns the external referral. 
	 * 
	 * @return external referral
	 */
	ExternalReferral getExternalReferral();
	
	/**
	 * Sets the external referral.
	 * 
	 * @param externalReferral external referral
	 */
	void setExternalReferral(ExternalReferral externalReferral);
