...
/**
 * Reason for status of appointment of internal referral.
 * 
 * @author Stephen Abson
 * @version 0.1.0 (May 20, 2014)
 * @since OMIS 3.0
 */
public interface InternalReferralStatusReason
	 ...
	 * 
	 * @param appointmentStatus status of appointment
	 */
	void setAppointmentStatus(HealthAppointmentStatus appointmentStatus);
	
	/**
	 * Returns status of the appointment.
	 * 
