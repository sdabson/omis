...
/**
 * Controller to display clinical referral form for an external referral.
 * 
...
public class ClinicalServicesReferalFormExternalReferralController {
	
	/* Report names. */
	
	private static final String 
		CLINICAL_SERVICES_REFERRAL_FORM_HWC_VERSION_REPORT_NAME 
			= "/Health/Clinical_Services_Referral_Form_HWC_Version";
	...
	public ClinicalServicesReferalFormExternalReferralController() {
	...
	/**
	 * Returns the report for the external referral.
	 * 
	 * @param externalReferral external referral
	 * @param reportFormat report format
	 * @return response entity with report
	 */
	@RequestMapping(value = "/clinicalServicesReferralForm.rtf",
