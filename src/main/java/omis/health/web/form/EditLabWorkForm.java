...
/**
 * Form to edit a single existing lab work.
 * 
 * @author Joel Norris
 * @version 0.1.0 (Sep 9, 2014)
 * @since OMIS 3.0
 */
public class EditLabWorkForm implements Serializable {
	...
	/**
	 * Instantiates a default instance of edit lab work form.
	 */
	public EditLabWorkForm() {
		//Default constructor.
	}
	...
	/**
	 * Sets whether the no meds restriction should be enforced.
	 * 
	 ...
	 * 
	 * @param byProvider bv provider assignment
	 */
