	...
	<table id="earlyReleaseRequestSummariesTable" class="listTable">
		<thead>
			<tr>
				...
				<th><fmt:message key="eligibilityDateLabel" /></th>
				<th><fmt:message key="docketLabel" /></th>
				<th><fmt:message key="requestDateLabel" /></th>
				<th><fmt:message key="requestStatusLabel" /></th>
				<th><fmt:message key="monthsOnProbationLabel" /></th>
				<th><fmt:message key="monthsInResidenceLabel" /></th>
				<th><fmt:message key="monthsEmployedLabel" /></th>
			</tr>
		</thead>
		<tbody>
