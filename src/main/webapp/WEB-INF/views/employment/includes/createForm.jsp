...
<form:form commandName="employmentForm" action="${pageContext.request.contextPath}/employment/create.html?offender=${offender.id}&employmentTerm=${employmentTerm.id}&employer=${employer.id}" class="editForm">
	...
	<fieldset>
		...
		<p>
			<c:if test="${employerStatus==false}">
				<c:if test="${employmentForm.employmentAddressOperation eq 'EXISTING'}">
					<form:radiobutton path="employmentAddressOperation" id="newAddressNo" value="EXISTING" checked ="checked"/><label class="fieldValueLabel" for="newAddressNo"><fmt:message key="newAddressNoLabel"/></label>
					<form:input path="addressQuery"  id="existingAddress" class="medium"/>
					<form:errors path="addressQuery" cssClass="error"/>
					<form:hidden path="address" id="searchEmploymentAddress"/>
					<form:errors path="address" cssClass="error"/>
					<br>
					<br>
					<form:radiobutton path="employmentAddressOperation" id="newAddressYes" value="NEW" /><label class="fieldValueLabel" for="newAddressYes"><fmt:message key="newAddressYesLabel"/></label>
				</c:if>
				<c:if test="${employmentForm.employmentAddressOperation eq 'NEW'}">
					<form:radiobutton path="employmentAddressOperation" id="newAddressNo" value="EXISTING"  /><label class="fieldValueLabel" for="newAddressNo"><fmt:message key="newAddressNoLabel"/></label>
					<form:input path="addressQuery"  id="existingAddress" class="medium"/>
					<form:errors path="addressQuery" cssClass="error"/>
					<form:hidden path="address" id="searchEmploymentAddress"/>
					<form:errors path="address" cssClass="error"/>
					<br>
					<br>
					<form:radiobutton path="employmentAddressOperation" id="newAddressYes" value="NEW" checked ="checked"/><label class="fieldValueLabel" for="newAddressYes"><fmt:message key="newAddressYesLabel"/></label>
				</c:if>
				<c:set var="addressFields" value="${employmentForm.addressFields}" scope="request"/>
