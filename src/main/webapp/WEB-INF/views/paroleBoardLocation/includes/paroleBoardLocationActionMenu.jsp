...
<fmt:bundle basename="omis.paroleboardlocation.msgs.paroleBoardLocation">
	<ul>
		<sec:authorize access="hasRole('PAROLE_BOARD_LOCATION_LIST') or hasRole('ADMIN')">
			<li>
				<a class="listLink" href="${pageContext.request.contextPath}/paroleBoardLocation/list.html">
				<span class="visibleLinkLabel"><fmt:message key="listParoleBoardLocationsLink"/></span></a>
			</li>
		</sec:authorize>
	</ul>
</fmt:bundle>