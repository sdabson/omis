...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<c:if test="${empty offenderHeaderResources}">
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/offender/style/offenderHeader.css?VERSION=7"/>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/resources/offender/scripts/offenderHeader.js?VERSION=1"></script>
	</c:if>