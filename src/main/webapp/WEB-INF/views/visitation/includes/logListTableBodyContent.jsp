...
<c:forEach var="visitSummary" items="${visitSummaries}" varStatus="status">
	<tr class="visitSummary" id="visitSummary">
		<td>
			<a class="actionMenuItem visitRowActionMenu" id="visitRowActionMenuLink${visitSummary.visitId}" href="${pageContext.request.contextPath}/visitation/visit/visitRowActionMenu.html?visit=${visitSummary.visitId}&currentlyVisiting=${visitSummary.currentlyVisiting}"></a>
		</td>
		<td>
			<c:choose>
