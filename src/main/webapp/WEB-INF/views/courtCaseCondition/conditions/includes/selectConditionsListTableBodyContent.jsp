...
<c:forEach var="conditionItem" items="${conditionItems}" varStatus="i">
	<tr>
		<td>
			...
			<form:input type="hidden" path="conditionItems[${i.index}].operation" />
		...
		<td>
			...
			<c:if test="${conditionItem.active and conditionSelectForm.conditionCategory eq 'SPECIAL'}">
			...
			<c:if test="${conditionSelectForm.conditionCategory eq 'SPECIAL'}">
