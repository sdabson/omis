...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<fmt:bundle basename="omis.courtcasecondition.msgs.courtCaseConditions">
		<form:form commandName="courtCaseConditionDateRangeForm" class="filterForm">
			<fieldset class="foregroundUltraLight">
				<legend class="foregroundLight"><fmt:message key="viewCourtCaseConditionsLabel"/></legend>
				<div>
