...
<table id="presentenceInvestigationRequestNoteTable" class="editTable">
	<thead>
		<tr>
			<th class="operations"><a class="actionMenuItem" id="presentenceInvestigationRequestNoteItemsActionMenuLink" href="${pageContext.request.contextPath}/presentenceInvestigation/home/presentenceInvestigationRequestNoteItemsActionMenu.html?presentenceInvestigationRequestNoteItemIndex=${presentenceInvestigationRequestNoteItemIndex}"></a></th>
