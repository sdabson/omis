...
<tr>
	<td><a class="actionMenuItem rowActionMenuItem" href="${pageContext.request.contextPath}/presentenceInvestigation/educationSummary/educationDocumentsRowActionMenu.html?educationAssociableDocument=${summary.educationDocumentId}"></a></td>
	<td>
