...
<head>
	<title><fmt:message key="victimSearchTitle"/></title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/victim/scripts/searchVictims.js"> </script>
</head>
<body>
	<h1><fmt:message key="victimSearchTitle"/></h1>
	<jsp:include page="includes/searchForm.jsp" />
	<c:if test="${not empty victimSummaries}">
