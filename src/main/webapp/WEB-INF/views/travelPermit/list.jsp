...
<head>
	<title>
		<fmt:message key="travelPermitTitle"/>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/travelPermit/scripts/travelPermits.js?VERSION=1"></script>
</head>
<body>
