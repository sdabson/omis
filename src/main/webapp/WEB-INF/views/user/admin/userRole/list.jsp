...
<head>
	<title><fmt:message key="userRoleListTitle"/></title>
...
<body>
	<h1><fmt:message key="userRoleListTitle"/></h1>
	<ul class="toolbar">
		<li>
			<a class="userAdminLink" href="${pageContext.request.contextPath}/user/admin/index.html">
				<fmt:message key="userAdminIndexLink"/></a>
		</li>
		<sec:authorize access="hasRole('ADMIN') or hasRole('USER_ROLE_CREATE')">
		<li>
			<a class="createLink" href="${pageContext.request.contextPath}/user/admin/userRole/create.html">
				<fmt:message key="createUserRoleLink"/></a>
		</li>
		</sec:authorize>
	</ul>
