...
<%--
 - Screen to change correctional status.
 -
...
<head>
	<title><fmt:message key="changeCorrectionalStatusHeader"/></title>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/supervision/style/links.css"/>
 	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/supervision/scripts/changeCorrectionalStatus.js"> </script>
...
<body>
	<h1><fmt:message key="changeCorrectionalStatusHeader"/></h1>
	...
	<jsp:include page="includes/changeCorrectionalStatusForm.jsp"/>
</body>
</fmt:bundle>
</html>