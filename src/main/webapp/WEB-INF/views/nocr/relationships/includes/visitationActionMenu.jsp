...
<fmt:bundle basename="omis.nocr.msgs.relationships">
	<ul>
		<li>
			...
			<ul>
				<li>
					<omis:reportPro reportPath="/Relationships/Visitation/Visitor_Search" decorate="no" title="" className="newTab reportLink"><fmt:message key="visitorSearchReportLinkLabel"/></omis:reportPro>
				</li>
			</ul>	
		<li>
