	...
	<ul>
		<li>
			...
			<ul>
				...
				<%--<li><omis:report reportPath="" decorate="no" title="" className="newTab reportLink"><fmt:message key="facilityRulesByFacilityReportLinkLabel"/></omis:report></li>--%>
			</ul>
		</li>
		<li>
			...
			<ul>
				<li><span><fmt:message key="noneAtThisTimeLabel" bundle="${nocr}"/></span></li>
				<%--<li><omis:report reportPath="" decorate="no" title="" className="newTab reportLink"><fmt:message key="administrativeRulesByFacilityReportLinkLabel"/></omis:report></li>--%>
			</ul>
		</li>
	</ul>
</fmt:bundle>