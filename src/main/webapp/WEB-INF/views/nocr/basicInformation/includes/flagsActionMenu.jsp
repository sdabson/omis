	...
	<ul>
		<li>
			...
			<ul>
				...
				<%--<li><omis:report reportPath="" decorate="no" title="" className="newTab reportLink"><fmt:message key="facilityOffenderFlagsReportLinkLabel"/></omis:report></li>--%>
			</ul>
		</li>
		<li>
			...
			<ul>
				<li><span><fmt:message key="noneAtThisTimeLabel" bundle="${nocr}"/></span></li>
				<%--<li><omis:report reportPath="" decorate="no" title="" className="newTab reportLink"><fmt:message key="communityOffenderFlagsReportLinkLabel"/></omis:report></li>--%>
			</ul>
		</li>
	</ul>
</fmt:bundle>