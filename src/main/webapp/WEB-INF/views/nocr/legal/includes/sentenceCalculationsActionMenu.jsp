...
<fmt:bundle basename="omis.nocr.msgs.legal">
	<ul>
		...
		<li>
			...
			<ul>
				<li><span><fmt:message key="noneAtThisTimeLabel" bundle="${nocr}"/></span></li>
				<%--<li><omis:report reportPath="" decorate="no" title="" className="newTab reportLink"><fmt:message key="applicationForRestorationOfForfeitedGoodTimeReportLinkLabel"/></omis:report></li>--%>
			</ul>
		</li>
	</ul>
</fmt:bundle>