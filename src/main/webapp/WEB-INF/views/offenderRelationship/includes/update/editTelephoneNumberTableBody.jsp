...
<thead>
	<tr>
		<th>
			<a class="actionMenuItem" id="telephoneNumbersEditActionMenuLink" href="${pageContext.request.contextPath}/offenderRelationship/update/telephoneNumberEditActionMenu.html?offender=${offender.id}"></a>
		</th>
...
<tbody id="telephoneNumbersTable">
	<c:forEach var="telephoneNumberItem" items="${telephoneNumberItems}" varStatus="status">	
		...
		<jsp:include page="editTelephoneNumberTableRow.jsp" />
	</c:forEach>					
</tbody>	
</table>
</fmt:bundle>