...
<fmt:bundle basename="omis.paroleboardcondition.msgs.paroleBoardCondition">
	...
	<span id="agreementAssociableDocumentItem${agreementAssociableDocumentItemIndex}" class="agreementAssociableDocumentItem ${agreementAssociableDisplayClass}">
		...
		href="${pageContext.request.contextPath}/paroleBoardCondition/removeAgreementAssociableDocument.html?agreementAssociable=${agreementAssociable.id}">
			...
			<c:choose>
				<c:when test="${not empty agreementAssociableDocumentItem.document}">
					...
					<a id="agreementAssociableDocumentDownloadLink${agreementAssociableDocumentItemIndex}"
		 					href="${pageContext.request.contextPath}/paroleBoardCondition/retrieveFile.html?document=${agreementAssociableDocumentItems[agreementAssociableDocumentItemIndex].document.id}"
							class="downloadLink">
