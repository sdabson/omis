		...
		<table id="conditions" class="listTable">
			...
			<tbody>
				<tr class="listTableRowNoHighlight">
					<td><a class="actionMenuItem rowActionMenuItem${paroleBoardAgreement.id}" id="rowActionMenuItem${paroleBoardAgreement.id}_standard"
						href="${pageContext.request.contextPath}/paroleBoardCondition/paroleBoardConditionsStandardRowActionMenu.html?paroleBoardAgreement=${paroleBoardAgreement.id}"></a>
					</td>
					<td colspan="2">
				...
				<c:forEach var="specialConditionsGroup" items="${specialConditions}">
					<tr class="listTableRowNoHighlight">
						<td><a class="actionMenuItem rowActionMenuItem${paroleBoardAgreement.id}" id="rowActionMenuItem${paroleBoardAgreement.id}_${specialConditionsGroup.key.id}"
						href="${pageContext.request.contextPath}/paroleBoardCondition/paroleBoardConditionsGroupRowActionMenu.html?paroleBoardAgreement=${paroleBoardAgreement.id}&conditionGroup=${specialConditionsGroup.key.id}"></a>
						</td>
						<td colspan="2">
