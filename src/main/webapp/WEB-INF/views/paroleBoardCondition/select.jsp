...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/paroleBoardCondition/scripts/paroleBoardConditionSelect.js?VERSION=1"> </script>
...
<body>
	...
	<h1>
		<a class="actionMenuItem" id="actionMenuLink" href="${pageContext.request.contextPath}/paroleBoardCondition/paroleBoardConditionsSelectActionMenu.html?offender=${offender.id}"></a>
		<fmt:message key="selectConditionsHeader">
			<c:choose>
				<c:when test="${not empty conditionGroup}">
					<fmt:param value="${conditionGroup.name}"/>
