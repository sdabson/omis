	...
	<ul>
		<sec:authorize access="hasRole('OFFENDER_PROFILE_VIEW') or hasRole('ADMIN')">
			<c:if test="${not empty offender}">
				...
				<li>
					<a href="${pageContext.request.contextPath}/offender/profileMedicalChartFaceSheetReport.html?offender=${offender.id}&reportFormat=PDF" class="newTab adobeReportLink"><fmt:message key="medicalChartFaceSheetReportLinkLabel"/></a>
				</li>
				<li>
