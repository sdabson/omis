...
<head>
	<title>
		<fmt:message key="locationDetailTitle"/>
	</title>
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/resources/location/scripts/location.js"> </script>
</head>
<body>
	<h1><fmt:message key="locationDetailTitle"/></h1>
