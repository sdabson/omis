...
<head>
	<title><fmt:message key="requestLabWorkRequirementTitle"/></title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/health/scripts/requestLabWorkRequirement.js"> </script>
...
<body>
	<h1><fmt:message key="requestLabWorkRequirementTitle"/></h1>
