...
<head>
	<title><fmt:message key="assessInternalReferralTitle"/></title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/health/scripts/assessInternalReferral.js"></script>
...
<body>
	<h1><fmt:message key="assessInternalReferralTitle"/></h1>
