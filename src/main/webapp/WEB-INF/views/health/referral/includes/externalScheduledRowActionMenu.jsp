...
<fmt:bundle basename="omis.health.msgs.health">
	<ul>
		...
		<li><a href="${pageContext.request.contextPath}/health/referral/external/clinicalServicesReferralForm.rtf?externalReferral=${scheduled.id}&reportFormat=RTF" title="<fmt:message key='clinicalServicesReferralFormLink'/>"class="reportLink"><span class="visibleLinkLabel"><fmt:message key="clinicalServicesReferralFormLink"/></span></a></li>
		<li><a href="${pageContext.request.contextPath}/health/referral/external/providerBillingMemo.rtf?externalReferral=${scheduled.id}&reportFormat=RTF" title="<fmt:message key='providerBillingMemoLink'/>"class="reportLink"><span class="visibleLinkLabel"><fmt:message key="providerBillingMemoLink"/></span></a></li>
	</ul>
</fmt:bundle>