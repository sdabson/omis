...
<head>
	<title><fmt:message key="requestExternalAuthorizationTitle"/></title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/health/scripts/requestExternalReferralAuthorization.js?version=1"></script>
</head>
<body>
	<h1><fmt:message key="requestExternalAuthorizationTitle"/></h1>
