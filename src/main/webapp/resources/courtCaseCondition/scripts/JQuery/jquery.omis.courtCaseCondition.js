...
function agreementAssociableDocumentItemsCreateOnClick() {
	$("#createAgreementAssociableDocumentItemLink").click(function() {
		$.ajax(config.ServerConfig.getContextPath() + "/courtCaseCondition/createAgreementAssociableDocumentItem.html",
		   {
				type: "GET",
				async: false,
				data: {
...
function documentTagItemsCreateOnClick(agreementAssociableDocumentItemIndex) {
	...
	$.ajax(config.ServerConfig.getContextPath() + "/courtCaseCondition/createDocumentTagItem.html",
	   {
			type: "GET",
			async: false,
			data: {
