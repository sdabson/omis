...
/**
 * Correctional status term list screen behavior.
 * 
 * Author: Stephen Abson
 */
window.onload = function() {
	applyActionMenu(document.getElementById("actionMenuLink"));
	var correctionalStatusTermsTableBody = document.getElementById("correctionalStatusTerms");
	var rowLinks = correctionalStatusTermsTableBody.getElementsByTagName("a");
