...
/**
 * Placement term list screen behavior.
 * 
...
window.onload = function() {
	...
	var placementTermsTableBody = document.getElementById("placementTerms");
	var rowLinks = placementTermsTableBody.getElementsByTagName("a");
