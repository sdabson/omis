...
/**
 * Assessments listing screen behavior.
 * 
 * Author: Josh Divine
 * Version: 0.1.0 Mar 29, 2017
 * Since: OMIS 3.0
 */
window.onload = function() {	
	...
	var assessmentsTableBody = document.getElementById("assessments");
	var rowLinks = assessmentsTableBody.getElementsByTagName("a");
