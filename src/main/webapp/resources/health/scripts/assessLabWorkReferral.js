/**
 * Form behavior for lab work referral assessment.
 * 
 * Author: Joel Norris 
 */
...
window.onload = function() {
	...
	for (var count = 0; count < labWorkAssessmentItemIndex; count++) {
		disableElement("nothingPerOral" + count);
		disableElement("noLeaky" + count);
		disableElement("noMeds" + count);
		applyDatePicker("labWorkResultsDate" + count);
		applyLabWorkAssessmentItemOnClick(count);
	}
