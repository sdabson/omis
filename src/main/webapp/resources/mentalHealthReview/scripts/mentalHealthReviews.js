...
*/
/**
 * Mental health review listing screen behavior.
 * 
 * Author: Josh Divine
...
window.onload = function() {
	...
	var mentalHealthReviewsTableBody = document.getElementById("mentalHealthReviews");
	var rowLinks = mentalHealthReviewsTableBody.getElementsByTagName("a");
