...
*/
/**
 * Unit manager review listing screen behavior.
 * 
 * Author: Josh Divine
...
window.onload = function() {
	...
	var unitManagerReviewsTableBody = document.getElementById("unitManagerReviews");
	var rowLinks = unitManagerReviewsTableBody.getElementsByTagName("a");
