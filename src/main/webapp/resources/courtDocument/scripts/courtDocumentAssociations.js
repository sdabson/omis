...
window.onload = function() {
	...
	addRowLinks(document.getElementById("courtDocumentAssociations"));
	addRowLinks(document.getElementById("unassociatedCourtDocumentAssociations"));
	
	function addRowLinks(elt) {
		if (elt != null) {
			rowLinks = elt.getElementsByTagName("a");
