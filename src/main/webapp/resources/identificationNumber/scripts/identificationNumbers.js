/**
 * Behavior for screen to list identification numbers.
 * 
 * @author Stephen Abson
 */
window.onload = function() {
	applyActionMenu(document.getElementById("actionMenuLink"));
	var identificationNumbersTableBody = document.getElementById("identificationNumbers");
	var rowLinks = identificationNumbersTableBody.getElementsByTagName("a");
