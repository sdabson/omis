...
/**
 * Tests method to update hearing decision notes.
 *
 * @author Josh Divine
 ...
 */
@Test
public class BoardHearingDecisionServiceUpdateHearingDecisionNoteTests
	...
	@Autowired
	@Qualifier("hearingDecisionNoteDelegate")
	private HearingDecisionNoteDelegate hearingDecisionNoteDelegate;
	...
	/**
	 * Tests the update of the date for a hearing decision note.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testUpdateHearingDecisionNoteDate() 
		...
		HearingDecisionNote hearingDecisionNote = this
				.hearingDecisionNoteDelegate.create(boardDecision, date, 
				description);
		Date newDate = this.parseDateText("01/02/2018");

		// Action
		hearingDecisionNote = this.boardHearingDecisionService
				.updateHearingDecisionNote(hearingDecisionNote, newDate, 
						description);
		...
		PropertyValueAsserter.create()
			...
			.performAssertions(hearingDecisionNote);
	}

	/**
	 * Tests the update of the description for a hearing decision note.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testUpdateHearingDecisionNoteDescription() 
			throws DuplicateEntityFoundException {
		// Arrangements
		Offender offender = this.offenderDelegate.createWithoutIdentity("Smith",
				"John", "Jay", null);
		...
		// Action
		hearingDecisionNote = this.boardHearingDecisionService
				.updateHearingDecisionNote(hearingDecisionNote, date, 
						newDescription);
	...
	public void testDuplicateEntityFoundException() 
		...
		HearingDecisionNote hearingDecisionNote = this
				.hearingDecisionNoteDelegate.create(boardDecision, secondDate, 
						description);
