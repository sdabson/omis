...
/**
 * Tests method to create board member decisions.
 *
 * @author Josh Divine
 ...
 */
@Test
public class BoardHearingDecisionServiceCreateBoardMemberDecisionTests
	...
	@Test
	public void testCreateBoardMemberDecision() 
		...
		BoardMemberDecision boardMemberDecision = this
				.boardHearingDecisionService.createBoardMemberDecision(
						boardDecision, boardHearingParticipant, decisionReason, 
						comments);
