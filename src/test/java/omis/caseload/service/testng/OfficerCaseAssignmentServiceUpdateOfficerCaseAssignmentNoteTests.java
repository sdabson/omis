...
/**
 * Tests method to update an officer case assignment.
 *
 * @author Josh Divine
 ...
 */
@Test
public class OfficerCaseAssignmentServiceUpdateOfficerCaseAssignmentNoteTests
	...
	/**
	 * Tests the update of the date for an officer case assignment note.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 * @throws DateConflictException if date conflict exists
	 */
	@Test
	public void testUpdateOfOfficerCaseAssignmentNoteDate() 
		...
		OfficerCaseAssignmentNote officerCaseAssignmentNote = this
				.officerCaseAssignmentNoteDelegate.create(officerCaseAssignment, 
						description, date);
		Date secondDate = this.parseDateText("09/08/2018");
		
		// Action
		officerCaseAssignmentNote = this.officerCaseAssignmentService
				.updateOfficerCaseAssignmentNote(officerCaseAssignmentNote, 
		...
		PropertyValueAsserter.create()
			...
			.addExpectedValue("date", secondDate)
			.performAssertions(officerCaseAssignmentNote);
	}
	
	/**
	 * Tests the update of the description for an officer case assignment note.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 * @throws DateConflictException if date conflict exists
	 */
	@Test
	public void testUpdateOfOfficerCaseAssignmentNoteDescription() 
			throws DuplicateEntityFoundException, DateConflictException {
		// Arrangements
		OfficerCaseAssignment officerCaseAssignment = 
				createOfficerCaseAssignment();
