...
/**
 * Tests method to create of officer case assignments.
 *
 * @author Josh Divine
 ...
 */
@Test
public class OfficerCaseAssignmentServiceCreateOfficerCaseAssignmentTests
	...
	/**
	 * Tests the creation of officer case assignments.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 * @throws DateConflictException if date conflict exists
	 */
	@Test
	public void testCreateOfficerCaseAssignment() 
		...
		OfficerCaseAssignment officerCaseAssignment = this
				.officerCaseAssignmentService.createOfficerCaseAssignment(
						offender, officer, startDate, endDate, 
	...
	public void testDuplicateEntityFoundException() 
		...
		// Action
		this.officerCaseAssignmentService.createOfficerCaseAssignment(offender, 
				officer, startDate, endDate, supervisionOffice, supervisionLevel);
	}
	...
	public void testDateConflictException() 
		...
		SupervisionLevelCategory supervisionLevel = this
				.supervisionLevelCategoryDelegate.create("Description", true);
		this.officerCaseAssignmentDelegate.create(offender, officer, startDate, 
				null, supervisionOffice, supervisionLevel);
