...
/**
 * Unit tests for service operations to create probation terms.
 * 
 * @author Josh Divine
 ...
 * @since OMIS 3.0
 */
public class ProbationTermServiceCreateTests
	...
	/**
	 * Tests creation of a probation term.
	 * 
	...
	public void testCreate() throws DuplicateEntityFoundException, 
		...
		// Action
		ProbationTerm probationTerm = this.probationTermService.create(
				courtCase, term, startDate, terminationDate, expirationDate,
				jailCredit, sentenceDays);
	...
	public void testProbationTermExistsException() 
		...
		// Action
		this.probationTermService.create(courtCase, term, startDate,
				terminationDate, expirationDate, jailCredit, sentenceDays);
	...
	public void testProbationTermConflictException() 
		...
		this.probationTermDelegate.create(offender, courtCase, term, startDate, 
				terminationDate, expirationDate, jailCredit, sentenceDays);
		startDate = this.parseDateText("02/05/2017");
		terminationDate = null;
		this.probationTermDelegate.create(offender, courtCase, term, startDate, 
				terminationDate, expirationDate, jailCredit, sentenceDays);
		startDate = this.parseDateText("02/03/2017"); 
		terminationDate = this.parseDateText("02/06/2017");
		this.probationTermDelegate.create(offender, courtCase, term, startDate, 
				terminationDate, expirationDate, jailCredit, sentenceDays);
		startDate = this.parseDateText("02/02/2017"); 
		terminationDate = this.parseDateText("02/08/2017");
	...
	public void testProbationTermExistsAfterException() 
		...
		this.probationTermDelegate.create(offender, courtCase, term, startDate,
				terminationDate, expirationDate, jailCredit, sentenceDays);
		startDate = this.parseDateText("01/31/2017"); 
		terminationDate = null;
