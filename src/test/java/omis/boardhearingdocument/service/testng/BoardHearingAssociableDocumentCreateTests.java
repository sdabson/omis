 ...
 */
@Test
public class BoardHearingAssociableDocumentCreateTests 
	...
	/**
	 * Tests the creation of board hearing associable documents.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testCreateBoardHearingAssociableDocument()
	...
	public void testDuplicateEntityFoundException()
		...
		Document document = this.documentDelegate.create(
				this.parseDateText("01/01/2018"), "filename", "fileextension", 
				"title");
		this.boardHearingAssociableDocumentDelegate.create(
				boardHearing, document);
		
		// Action
		this.boardHearingDocumentService.createBoardHearingAssociableDocument(
				boardHearing, document);
	}
