 ...
 */
@Test
public class SentenceServiceCreateSentenceTests 
	...
	public void testSentenceExistsException() 
		...
		Integer changeOrder = this.sentenceDelegate
				.countSentencesByConviction(conviction) + 1;
		this.sentenceDelegate.sentence(conviction, connection, prisonTerm, 
		...
		// Action
		this.sentenceService.sentence(conviction, connection, prisonTerm, 
				probationTerm, deferredTerm, category, lengthClassification, 
				legalDispositionCategory, effectiveDate, pronouncementDate, 
				credit, turnSelfInDate);
	}
	...
	public void testSentence() 
		...
		// Action
		Sentence sentence = this.sentenceService.sentence(conviction, 
		...
		// Assert
		assertValues(sentence, conviction, connection, prisonTerm, 
				probationTerm, deferredTerm, category, lengthClassification, 
				legalDispositionCategory, effectiveDate, pronouncementDate, 
				credit, turnSelfInDate);
	}
