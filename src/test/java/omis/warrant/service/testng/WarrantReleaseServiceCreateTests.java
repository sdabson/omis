...
public class WarrantReleaseServiceCreateTests
	...
	@Test
	public void testWarrantReleaseCreate() throws WarrantReleaseExistsException, 
		CountryExistsException, StateExistsException, CityExistsException, 
		ZipCodeExistsException, WarrantExistsException, 
	...
	private Warrant createWarrant(Country country, State state, City city,
		ZipCode zipCode) throws WarrantExistsException, 
		DuplicateEntityFoundException {
