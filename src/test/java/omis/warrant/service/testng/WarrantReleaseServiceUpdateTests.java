...
public class WarrantReleaseServiceUpdateTests
	...
	@Test
	public void testWarrantReleaseUpdate() throws DuplicateEntityFoundException {
		...
		final Location location0 = this.locationDelegate.create(organization,
		...
		WarrantRelease warrantRelease = this.warrantReleaseDelegate
				.create(warrant, "Old Instructions", county0, facility0,
		...
		warrantRelease = this.warrantReleaseService
				.update(warrantRelease, instructions, county, facility,
