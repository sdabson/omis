...
/**
 * EducationalAchievementCreateTests.java
 * 
...
public class EducationalAchievementCreateTests 
	...
	public void testCreate()
		...
		assert achievementDate.equals(achievement.getDate())
		: String.format("Wrong date for the achievement: "
				+ "%s found; %s expected",
