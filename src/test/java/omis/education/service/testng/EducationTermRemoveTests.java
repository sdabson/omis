...
public class EducationTermRemoveTests 
	...
	@Autowired
	@Qualifier("educationTermDelegate")
	private EducationTermDelegate educationTermDelegate;
	...
	assert !this.educationTermDelegate.findByOffender(offender)
		.contains(educationTerm) 
		: "Education Term was not removed!";
