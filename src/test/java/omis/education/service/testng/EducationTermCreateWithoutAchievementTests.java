...
/**
 * EducationTermCreateWithoutAchievementTests.java
 * 
...
public class EducationTermCreateWithoutAchievementTests 
	...
	: String.format("Wrong verification signature date: %s found; %s expected",
	...
	: String.format("Wrong verification signature method: %s found; %s expected",
