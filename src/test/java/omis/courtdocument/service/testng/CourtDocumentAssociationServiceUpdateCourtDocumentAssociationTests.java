 ...
 */
@Test
public class CourtDocumentAssociationServiceUpdateCourtDocumentAssociationTests
	...
	/**
	 * Tests the update of the docket for a court document association.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exist
	 * @throws DocketExistsException if docket already exists
	 */
	@Test
	public void testUpdateCourtDocumentAssociationDocket() 
		...
		CourtDocumentAssociation courtDocumentAssociation = this
				.courtDocumentAssociationDelegate.create(docket, offender,
						document, date, category);
		Docket newDocket = this.docketDelegate.create(offender, court, 
				"DC-12345-12");
		
		// Action
		courtDocumentAssociation = this.courtDocumentAssociationService
				.updateCourtDocumentAssociation(courtDocumentAssociation, 
						newDocket, document, date, category);

		// Assertions
		PropertyValueAsserter.create()
			.addExpectedValue("docket", newDocket)
	...
	/**
	 * Tests the update of the document for a court document association.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exist
	 * @throws DocketExistsException if docket already exists
	 */
	@Test
	public void testUpdateCourtDocumentAssociationDocument() 
			throws DuplicateEntityFoundException, DocketExistsException {
		// Arrangements
		Offender offender = this.offenderDelegate.createWithoutIdentity("Smith",
				"John", "Jay", null);
		...
		CourtDocumentAssociation courtDocumentAssociation = this
				.courtDocumentAssociationDelegate.create(docket, offender,
						document, date, category);
		Document newDocument = this.documentDelegate.create(date, "Filename2", 
				"ext", "Title");
		
		// Action
		courtDocumentAssociation = this.courtDocumentAssociationService
				.updateCourtDocumentAssociation(courtDocumentAssociation, 
						docket, newDocument, date, category);
	...
	/**
	 * Tests the update of the date for a court document association.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exist
	 * @throws DocketExistsException if docket already exists
	 */
	@Test
	public void testUpdateCourtDocumentAssociationDate() 
			throws DuplicateEntityFoundException, DocketExistsException {
		// Arrangements
		Offender offender = this.offenderDelegate.createWithoutIdentity("Smith",
				"John", "Jay", null);
		...
		CourtDocumentAssociation courtDocumentAssociation = this
				.courtDocumentAssociationDelegate.create(docket, offender,
						document, date, category);
		Date newDate = this.parseDateText("08/02/2018");
		
		// Action
		courtDocumentAssociation = this.courtDocumentAssociationService
				.updateCourtDocumentAssociation(courtDocumentAssociation, 
						docket, document, newDate, category);
	...
	/**
	 * Tests the update of the category for a court document association.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exist
	 * @throws DocketExistsException if docket already exists
	 */
	@Test
	public void testUpdateCourtDocumentAssociationCategory() 
			throws DuplicateEntityFoundException, DocketExistsException {
		// Arrangements
		Offender offender = this.offenderDelegate.createWithoutIdentity("Smith",
				"John", "Jay", null);
		...
		CourtDocumentAssociation courtDocumentAssociation = this
				.courtDocumentAssociationDelegate.create(docket, offender,
						document, date, category);
		CourtDocumentCategory newCategory = this.courtDocumentCategoryDelegate
				.create("Category2", true);
		
		// Action
		courtDocumentAssociation = this.courtDocumentAssociationService
				.updateCourtDocumentAssociation(courtDocumentAssociation, 
						docket, document, date, newCategory);
	...
	public void testDuplicateEntityFoundException() 
		...
		this.courtDocumentAssociationDelegate.create(docket, offender, document, 
				date, category);
		Document secondDocument  = this.documentDelegate.create(date, 
				"Filename2", "ext", "Title");
		CourtDocumentAssociation courtDocumentAssociation = this
				.courtDocumentAssociationDelegate.create(docket, offender,
						secondDocument, date, category);

		// Action
		courtDocumentAssociation = this.courtDocumentAssociationService
				.updateCourtDocumentAssociation(courtDocumentAssociation, 
						docket, document, date, category);
	}
