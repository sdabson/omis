...
/**
 * Tests service to create offender criminal associations.
 *
...
public class CriminalAssociationServiceCreateTests 
	...
	public void testAssociate() 
		...
		//Action
		CriminalAssociation association = this.criminalAssociationService
				.associate(offender, criminalAssociate, dateRange, category, flags);
		//Assert
		PropertyValueAsserter.create()
			...
			.addExpectedValue("criminalAssociationCategory", category)
	...
	public void testCriminalAssociationExistsException() 
		...
		//Arrangements
		Person associate = this.personDelegate.create(
				"Associate", "Criminal", "Two", "M");		
		Offender offender = this.offenderDelegate.createWithoutIdentity(
				"Criminal", "Offender", "One", "M");		
		DateRange dateRange = new DateRange(this.parseDateText("01/01/2017"), 
		...
		CriminalAssociationFlags flags = new CriminalAssociationFlags();
		flags.setWitness(true);		
		this.criminalAssociationServiceDelegate.associateCriminally(offender, 
				associate, dateRange, category, flags);
		//Action
		this.criminalAssociationService
				.associate(offender, associate, dateRange, category, flags);		
	}
		
	/**
	 * Tests {@code CriminalAssociationCategoryExistsException} is thrown.
	 *
	 *
	 * @throws ReflexiveRelationshipException reflexive relationship exception
	 * @throws CriminalAssociationExistsException criminal association exists
	...
	@Test(expectedExceptions = {
			CriminalAssociationCategoryExistsException.class})
	public void testCriminalAssociationCategoryExistsException() 
			throws CriminalAssociationCategoryExistsException, 
			CriminalAssociationExistsException, ReflexiveRelationshipException {
		//Arrangements
		Person associate = this.personDelegate.create(
		...
		CriminalAssociationCategory newCategory 
			= this.criminalAssociationCategoryDelegate.create(
					"categoryName", (short) 1, true);
		dateRange = new DateRange(this.parseDateText("04/01/2017"), 
				this.parseDateText("12/01/2017"));
		//Action
		this.criminalAssociationService
				.associate(offender, associate, dateRange, newCategory, flags);		
	}
