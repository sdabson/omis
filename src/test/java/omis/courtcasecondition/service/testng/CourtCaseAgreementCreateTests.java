...
/**
 * Court Case Condition Create Tests.
 * 
 ...
 *
 */
public class CourtCaseAgreementCreateTests
	 ...
	 */
	@Test
	public void testCourtCaseAgreementCreate()
		...
		final Address address = this.addressDelegate.findOrCreate(
				"123value", null, null, null, zipCode);
	...
	public void testAgreementCreate() throws DuplicateEntityFoundException {
		...
		final Agreement agreement = this.courtCaseAgreementService
				.createAgreement(offender, startDate, endDate,
	 ...
	 */
	@Test
	public void testAgreementNoteCreate() throws DuplicateEntityFoundException {
		final Offender offender = this.offenderDelegate.createWithoutIdentity(
				"Wayne", "Bruce", "Alen", null);
		final Agreement agreement = this.courtCaseAgreementService
				.createAgreement(offender, this.parseDateText("05/12/2017"), 
