 ...
 */
@Test
public class AlternativeOffenderIdentityServiceCreateCityTests
	...
	@Test
	public void testCreateCity() throws DuplicateEntityFoundException {
		// Arrangements
		String name = "Helena";
		...
		// Action
		City city = this.alternativeOffenderIdentityService.createCity(
				name, state, country);
	...
	public void testDuplicateEntityFoundException() 
		...
		final State state = this.stateDelegate.create(
				"Montana", "MT", country, true, true);
		this.cityDelegate.create(name, true, state, country);

		// Action
		this.alternativeOffenderIdentityService.createCity(
				name, state, country);
	}
}