...
/**
 * Tests method to update alternative identities without SSNs.
 *
...
public class AlternativeOffenderIdentityServiceUpdateAssociationWithoutSsnTests
	...
	private AlternativeOffenderIdentityService alternativeOffenderIdentityService;

	/* Test methods. */

	/**
	 * Tests update of alternative identity association.
	 * 
	 ...
	 * association exists
	 */
	public void testUpdateAssociationWithoutSsn()
		...
		AlternativeIdentityAssociation alternativeIdentityAssociation 
			= this.alternativeOffenderIdentityService
				.updateAssociationWithoutSsn(association, 
						alternativeNameAssociation, birthDate, 
						birthCountry, birthPlace, stateIdNumber, sex, dateRange, 
						alternativeIdentityCategory2);
	 ...
	 * 
	 * @throws AlternativeIdentityAssociationExistsException if
	 * alternative identity association exists
	 * @throws PersonIdentityExistsException if person identity exists
	 * - asserted
	 * @throws AlternativeNameAssociationExistsException if alternative
	...
	public void testPersonIdentityExistsException()
		...
		AlternativeNameAssociation alternativeNameAssociation 
			= this.alternativeNameAssociationDelegate.create(
					personName, dateRange, category);
		offender = this.offenderDelegate.create(lastName2, firstName2, 
				middleName2, suffix2, socialSecurityNumber, 
				stateIdNumber, birthDate, birthCountry, birthState, birthPlace, 
				sex);		
		PersonIdentity personIdentity = this.personIdentityDelegate.create(
				offender, sex, birthDate, birthCountry, birthState, birthPlace, 
				socialSecurityNumber, stateIdNumber, null, null);
		this.alternativeIdentityAssociationDelegate.create(personIdentity, 
				dateRange, alternativeIdentityCategory, 
				alternativeNameAssociation);	
		...
		AlternativeIdentityAssociation association 
			= this.alternativeIdentityAssociationDelegate.create(
					personIdentity, dateRange2, alternativeIdentityCategory2, 
					alternativeNameAssociation);
		...
		this.alternativeOffenderIdentityService
			.updateAssociationWithoutSsn(association, 
					...
					birthPlace, stateIdNumber, sex, dateRange, 
					alternativeIdentityCategory);
	}
