...
/**
 * Tests method to end bed placements.
 *
 * @author Josh Divine
 * @version 0.0.1
 * @since OMIS 3.0
 */
public class BedPlacementServiceEndBedPlacementTests
	...
	/**
	 * Test the ending of a bed placement.
	 * 
	 ...
	 */
	@Test
	public void testEndBedPlacement() throws BedPlacementDateConflictException,
		...
		Date endDate = this.parseDateText("03/01/2017");

		// Action
		bedPlacement = this.bedPlacementService.endBedPlacement(bedPlacement, 
				endDate);
		...
		PropertyValueAsserter.create()
			...
			.addExpectedValue("dateRange", 
					new DateRange(dateRange.getStartDate(), endDate))
