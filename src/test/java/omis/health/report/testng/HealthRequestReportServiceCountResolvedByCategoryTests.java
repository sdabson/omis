...
/**
 * Test the counting for health request summary by excluding status
 *
 * @author Yidong Li
...
public class HealthRequestReportServiceCountResolvedByCategoryTests 
	...
	/**
	 * Test the counting for health request summary by status
	 * @throws DuplicateEntityFoundException 
	 */
	@Test
	public void testCountResolvedByCategory()
		throws DuplicateEntityFoundException {
		// Arrangements
		...
		// Action
		long count = this.healthRequestReportService
			.countResolvedByCategory(facility, null,
			HealthRequestCategory.values());
