...
/**
 * Test the counting for health request summary
 *
 * @author Yidong Li
...
public class HealthRequestReportServiceCountTests 
	...
	public void testCountOpenByCategory()
		...
		// Action
		long count = this.healthRequestReportService.count(facility, null);
