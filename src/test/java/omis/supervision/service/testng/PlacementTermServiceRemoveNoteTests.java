...
/**
 * Tests removal of note for placement terms from placement term service.
 * 
...
public class PlacementTermServiceRemoveNoteTests
	...
	/**
	 * Tests removal of notes for placement terms from placement term service.
	 * 
	 * @throws DuplicateEntityFoundException if related entities exist
	 * @throws PlacementTermNoteExistsException if placement term not exists
	 */
	@Test
	public void testRemove()
		...
		DateRange dateRange = new DateRange(
				this.parseDateText("12/13/2016"), null);
		SupervisoryOrganization supervisoryOrganization
			= this.supervisoryOrganizationDelegate
				.create("Parole Center", "PCT", null);
		...
		String value = "Exciting note";
		PlacementTermNote note = this.placementTermNoteDelegate
				.create(placementTerm, date, value);
		
		// Action
		this.placementTermService.removeNote(note);
		
		// Assertions
		assert this.placementTermService.findNotesByPlacementTerm(
				placementTerm).isEmpty()
			: "Placement term note was not removed";
	}
