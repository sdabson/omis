...
/**
 * Tests method to update offender relation without a social secutiy number.
 *
 ...
 */
@Test
public class UpdateOffenderRelationServiceUpdateRelationWithoutSsnTests
	...
	/**
	 * Test update relations with out social security number.
	 *
	 *
	 ...
	 */
	@Test
	public void testUpdateRelationWithoutSsn() 
		...
		// Action
		person = this.updateOffenderRelationService.updateRelationWithoutSsn(
			person, lastName, firstName, middleName, suffix, sex, birthDate, 
			birthCountry, birthState, birthCity, stateId, false, 
			null);
		...
		PropertyValueAsserter.create()
			...
			.addExpectedValue("identity.deceased", false)
			.addExpectedValue("identity.deathDate", null)
			.performAssertions(person);
	}

	/**
	 * Test person name exists without social security number.
	 *
	 *
	* @throws PersonNameExistsException person name exists
	 * @throws PersonIdentityExistsException person identity exists
	...
	public void testPersonNameExistsException() 
		...
		Person person = this.personDelegate.createWithIdentity(lastName, 
				firstName, middleName, suffix, sex, birthDate, birthCountry, 
				birthState, birthCity, socialSecurityNumber, stateId, false, 
				null);
	...
	public void testPersonIdentityExistsException() 
		...
		Person person = this.personDelegate.createWithIdentity(lastName, 
				...
				birthState, birthCity, socialSecurityNumber, stateId, null, 
				null);
		this.personIdentityDelegate.create(person, sex, birthDate, birthCountry,
				birthState, birthCity, socialSecurityNumber, stateId, null, 
				null);
		...
		this.updateOffenderRelationService.updateRelationWithoutSsn(
			person, lastName, firstName, middleName, suffix, sex, birthDate, 
			birthCountry, birthState, birthCity, stateId, null, 
			null);
	}
