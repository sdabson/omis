...
/**
 * Tests method to create Early Release Requests.
 *
 * @author Annie Wahl
 ...
 */
@Test
public class EarlyReleaseRequestServiceCreateEarlyReleaseRequestTests
	...
	@Test
	public void testCreateEarlyReleaseRequest()
		...
		EarlyReleaseRequest earlyReleaseRequest =
				this.earlyReleaseRequestService.createEarlyReleaseRequest(
						docket, requestDate, category, requestStatus,
						judgeResponse, requestBy, approvalDate, comments);
	...
	public void testEarlyReleaseRequestExistsException()
		...
		Date approvalDate = this.parseDateText("02/28/2019");
		String comments = "Early Release Request Comments";
		earlyReleaseRequestDelegate.create(docket, requestDate, category,
