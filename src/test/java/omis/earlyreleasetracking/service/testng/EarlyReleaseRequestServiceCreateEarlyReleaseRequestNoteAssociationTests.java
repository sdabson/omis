...
/**
 * Tests method to create Early Release Request Note Associations.
 *
 * @author Annie Wahl
 ...
 */
@Test
public class EarlyReleaseRequestServiceCreateEarlyReleaseRequestNoteAssociationTests
	...
	@Autowired
	private EarlyReleaseRequestNoteAssociationDelegate
	...
	@Test
	public void testCreateEarlyReleaseRequestNoteAssociation()
		...
		Date date = this.parseDateText("02/19/2019");
