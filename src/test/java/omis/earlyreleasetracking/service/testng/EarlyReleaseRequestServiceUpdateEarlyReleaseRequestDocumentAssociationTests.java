...
/**
 * Tests method to update Early Release Request Document Associations.
 *
 * @author Annie Wahl
 ...
 */
@Test
public class EarlyReleaseRequestServiceUpdateEarlyReleaseRequestDocumentAssociationTests
	...
	@Test
	public void testUpdateEarlyReleaseRequestDocumentAssociation()
			throws EarlyReleaseRequestDocumentAssociationExists,
			DuplicateEntityFoundException, DocketExistsException {
		// Arrangements
		Document oldDocument = this.documentDelegate.create(
				this.parseDateText("01/01/2010"), "old", ".old", "Old.");
		...
		EarlyReleaseRequestDocumentAssociation
				...
				this.earlyReleaseRequestDocumentAssociationDelegate.create(
						oldDocument, earlyReleaseRequest);
		Document document = this.documentDelegate.create(
				this.parseDateText("02/02/2020"), "new", ".new", "New.");;

		// Action
		earlyReleaseRequestDocumentAssociation = this.earlyReleaseRequestService
