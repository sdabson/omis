...
/**
 * Tests method to update Early Release Request Internal Approvals.
 *
 * @author Annie Wahl
 ...
 */
@Test
public class EarlyReleaseRequestServiceUpdateEarlyReleaseRequestInternalApprovalTests
	...
	@Test
	public void testUpdateEarlyReleaseRequestInternalApproval()
		...
		EarlyReleaseRequestInternalApproval
			...
			this.earlyReleaseRequestInternalApprovalDelegate.create(
					earlyReleaseRequest, "Old Name",
					this.parseDateText("01/01/2010"),
					InternalApprovalDecisionCategory.DENY, "Old Narrative.");
		String name = "Name";
		...
		// Action
		earlyReleaseRequestInternalApproval = this.earlyReleaseRequestService
