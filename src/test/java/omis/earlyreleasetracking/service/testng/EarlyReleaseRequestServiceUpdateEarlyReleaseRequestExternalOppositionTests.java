...
/**
 * Tests method to update Early Release Request External Oppositions.
 *
 * @author Annie Wahl
 ...
 */
@Test
public class EarlyReleaseRequestServiceUpdateEarlyReleaseRequestExternalOppositionTests
	...
	@Test
	public void testUpdateEarlyReleaseRequestExternalOpposition()
		...
		ExternalOppositionPartyCategory oldParty =
				this.externalOppositionPartyCategoryDelegate.create(
						"Old Party", true);
		EarlyReleaseRequestExternalOpposition
				earlyReleaseRequestExternalOpposition =
				this.earlyReleaseRequestExternalOppositionDelegate.create(
						earlyReleaseRequest, oldParty,
						this.parseDateText("02/02/2018"), "Old Narrative");
		ExternalOppositionPartyCategory party =
				this.externalOppositionPartyCategoryDelegate.create(
						"New Party", true);
		Date date = this.parseDateText("04/10/2019");
		String narrative = "A very new definitely new narrative.";

		// Action
		earlyReleaseRequestExternalOpposition = this.earlyReleaseRequestService
