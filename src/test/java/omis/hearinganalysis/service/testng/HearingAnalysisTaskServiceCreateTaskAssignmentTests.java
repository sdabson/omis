...
/**
 * Tests method to create task assignments.
 *
 * @author Josh Divine
 * @version 0.0.1
 * @since OMIS 3.0
 */
public class HearingAnalysisTaskServiceCreateTaskAssignmentTests
	...
	/**
	 * Tests the creation of task assignments.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testCreateTaskAssignment() 
		...
		// Action
		TaskAssignment taskAssignment = this.hearingAnalysisTaskService
				.createTaskAssignment(task, assigneeAccount, assignedDate);
