...
/**
 * Tests method to create parole reviews.
 *
 * @author Josh Divine
 * @version 0.0.1
 * @since OMIS 3.0
 */
@Test
public class ParoleReviewServiceCreateParoleReviewTests
	...
	/**
	 * Tests the creation of parole reviews.
	 * 
	 * @throws DuplicateEntityFoundException if entity already exists
	 */
	@Test
	public void testCreateParoleReview() 
		...
		ParoleReview paroleReview = this.paroleReviewService
				.createParoleReview(staffAssignment, date, text, offender,
	...
	public void testDuplicateEntityFoundException() 
		...
		StaffRoleCategory staffRole = this.staffRoleCategoryDelegate.create(
				"Name", true);
		this.paroleReviewDelegate.create(staffAssignment, date, text, 
				offender, endorsement, staffRole);
		
		// Action
		this.paroleReviewService.createParoleReview(staffAssignment, 
				date, text, offender, endorsement, staffRole);
	}
