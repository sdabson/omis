 ...
 */
@Test
public class ParoleReviewServiceUpdateDocumentTests
	...
	public void testUpdateDocumentDate() throws DuplicateEntityFoundException {
		...
		// Action
		document = this.paroleReviewService.updateDocument(document, newDate, 
				title);
	...
	public void testUpdateDocumentTitle() throws DuplicateEntityFoundException {
		...
		// Action
		document = this.paroleReviewService.updateDocument(document, date, 
				newTitle);
