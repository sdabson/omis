...
/**
 * Tests method to update parole review notes.
 *
 * @author Josh Divine
 ...
 */
@Test
public class ParoleReviewServiceUpdateParoleReviewNoteTests
	...
	/**
	 * Test the update of the date for a parole review note.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testUpdateParoleReviewNoteDate() 
		...
		ParoleReviewNote paroleReviewNote = this.paroleReviewNoteDelegate
				.create(paroleReview, date, description);
		Date newDate = this.parseDateText("01/02/2018");

		// Action
		paroleReviewNote = this.paroleReviewService.updateParoleReviewNote(
				paroleReviewNote, paroleReview, description, newDate);
	...
	/**
	 * Test the update of the description for a parole review note.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testUpdateParoleReviewNoteDescription() 
			throws DuplicateEntityFoundException {
		// Arrangements
		Person staffMember = this.personDelegate.create("Smith", "John", "Jay", 
				null);
		...
		// Action
		paroleReviewNote = this.paroleReviewService.updateParoleReviewNote(
				paroleReviewNote, paroleReview, newDescription, date);
	...
	public void testDuplicateEntityFoundException() 
		...
		ParoleReviewNote paroleReviewNote = this.paroleReviewNoteDelegate
				.create(paroleReview, date, secondDescription);

		// Action
		paroleReviewNote = this.paroleReviewService.updateParoleReviewNote(
				paroleReviewNote, paroleReview, description, date);
	}
