 ...
 */
@Test
public class ParoleReviewServiceCreateDocumentTests
	...
	public void testCreateDocument() throws DuplicateEntityFoundException {
		...
		// Action
		Document document = this.paroleReviewService.createDocument(date, 
	...
	public void testDuplicateEntityFoundException() 
		...
		// Action
		this.paroleReviewService.createDocument(date, title, filename, 
				fileExtension);
	}
