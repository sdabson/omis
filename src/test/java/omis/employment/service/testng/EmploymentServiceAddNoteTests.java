 ...
 * @since OMIS 3.0
 */
public class EmploymentServiceAddNoteTests
	...
	public void testAddNote() throws DuplicateEntityFoundException {
		...
		// Action
		EmploymentNote employmentNote = this.employmentService.addNote(term, 
				value, date);
	...
	public void testDuplicateEntityFoundException() throws DuplicateEntityFoundException {
		...
		// Action
		this.employmentService.addNote(term, value, date);
	}
