...
/**
 * Tests method to update victim note.
 *
 ...
 */
@Test
public class VictimNoteServiceUpdateTests
	...
	@Test
	public void testUpdate() throws VictimNoteExistsException, 
	...
	String value = "Testing note creation and update";
	VictimNote victimNote = this.victimNoteDelegate.create(
			victim, category, association, date, value);
	
	// Action
	victimNote = this.victimNoteService.update(victimNote, category, association, 
			 date, value);
	...
	@Test
	public void testUpdateWithoutAssociation() throws VictimNoteExistsException, 
	VictimNoteCategoryExistsException, VictimExistsException, 
	RelationshipExistsException, ReflexiveRelationshipException {
	// Arrangements
	Person victim = this.personDelegate.create("LastName", "FirstName", 
	...
	// Action
	victimNote = this.victimNoteService.update(victimNote, category, null,
			 date, value);
