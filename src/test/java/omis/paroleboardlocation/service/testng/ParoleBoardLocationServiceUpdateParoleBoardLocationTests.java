...
/**
 * Tests method to update parole board locations.
 *
 * @author Josh Divine
 ...
 */
@Test
public class ParoleBoardLocationServiceUpdateParoleBoardLocationTests
	...
	/**
	 * Tests the update of the location for a parole board location.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testUpdateParoleBoardLocationLocation() 
		...
		ParoleBoardLocation paroleBoardLocation = this
				.paroleBoardLocationDelegate.create(location, 
						videoConferenceCapable);
		Organization newOrg = this.organizationDelegate.create("Org2", "O2", 
				null);
		Location newLocation = this.locationDelegate.create(newOrg, null, 
				address);

		// Action
		paroleBoardLocation = this.paroleBoardLocationService
				.updateParoleBoardLocation(paroleBoardLocation, newLocation, 
						videoConferenceCapable);
	...
	/**
	 * Tests the update of the video conference capable for a parole board 
	 * location.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testUpdateParoleBoardLocationVideoConferenceCapable() 
			throws DuplicateEntityFoundException {
		// Arrangements
		Country country = this.countryDelegate.create("Country", "C", true);
		State state = this.stateDelegate.create("State", "ST", country, true, 
		...
		ParoleBoardLocation paroleBoardLocation = this
				.paroleBoardLocationDelegate.create(location, 
						videoConferenceCapable);
		Boolean newVideoConferenceCapable = false;

		// Action
		paroleBoardLocation = this.paroleBoardLocationService
				.updateParoleBoardLocation(paroleBoardLocation, location, 
						newVideoConferenceCapable);

		// Assertions
		PropertyValueAsserter.create()
			.addExpectedValue("location", location)
			.addExpectedValue("videoConferenceCapable", 
					newVideoConferenceCapable)
			.performAssertions(paroleBoardLocation);
	}
	...
	public void testDuplicateEntityFoundException() 
		...
		this.paroleBoardLocationDelegate.create(location, 
				videoConferenceCapable);
		Organization secondOrg = this.organizationDelegate.create("Org2", "O2", 
				null);
		Location secondLocation = this.locationDelegate.create(secondOrg, null, 
				address);
		ParoleBoardLocation paroleBoardLocation = this
				.paroleBoardLocationDelegate.create(secondLocation, 
						videoConferenceCapable);
