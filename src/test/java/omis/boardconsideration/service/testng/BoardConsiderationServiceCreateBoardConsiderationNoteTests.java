...
/**
 * Tests method to create board consideration notes.
 *
 * @author Josh Divine
 ...
 */
@Test
public class BoardConsiderationServiceCreateBoardConsiderationNoteTests
	...
	/**
	 * Tests the creation of board consideration notes.
	 * 
	 ...
	 */
	@Test
	public void testCreateBoardConsiderationNote() 
		...
		BoardConsiderationNote boardConsiderationNote = this
				.boardConsiderationService.createBoardConsiderationNote(
						hearingAnalysis, description, date);
