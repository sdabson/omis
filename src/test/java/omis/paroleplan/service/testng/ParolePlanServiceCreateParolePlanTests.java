...
/**
 * Tests method to create parole plans.
 *
 * @author Josh Divine
 ...
 */
@Test
public class ParolePlanServiceCreateParolePlanTests
	...
	/**
	 * Tests the creation of parole plans.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testCreateParolePlan() throws DuplicateEntityFoundException {
		// Arrangements
		...
		// Action
		ParolePlan parolePlan = this.parolePlanService.createParolePlan(
	...
	public void testDuplicateEntityFoundException() 
		...
		String residencePlan = "Residence plan";
		String treatmentPlan = "Treatment plan";
		this.parolePlanDelegate.create(paroleEligibility, evaluator, 
				evaluationDescription, vocationalPlan, residencePlan, 
				treatmentPlan);
		
		// Action
		this.parolePlanService.createParolePlan(paroleEligibility, evaluator, 
				evaluationDescription, vocationalPlan, residencePlan, 
				treatmentPlan);
	}
