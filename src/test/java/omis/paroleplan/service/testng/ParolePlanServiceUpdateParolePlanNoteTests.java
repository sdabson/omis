...
/**
 * Tests method to update parole plan notes.
 *
 * @author Josh Divine
 ...
 */
@Test
public class ParolePlanServiceUpdateParolePlanNoteTests
	...
	/**
	 * Tests the update of the date for a parole plan note.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testUpdateParolePlanNoteDate() 
		...
		ParolePlanNote parolePlanNote = this.parolePlanNoteDelegate.create(
				parolePlan, description, date);
		Date newDate = this.parseDateText("01/02/2018");
		
		// Action
		parolePlanNote = this.parolePlanService.updateParolePlanNote(
				parolePlanNote, description, newDate);
	...
	/**
	 * Tests the update of the description for a parole plan note.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testUpdateParolePlanNoteDescription() 
			throws DuplicateEntityFoundException {
		// Arrangements
		Person staffMember = this.personDelegate.create("Smith", "John", "Jay", 
				null);
		...
		// Action
		parolePlanNote = this.parolePlanService.updateParolePlanNote(
				parolePlanNote, newDescription, date);
	...
	public void testDuplicateEntityFoundException() 
		...
		Date secondDate = this.parseDateText("01/01/2018");
		ParolePlanNote parolePlanNote = this.parolePlanNoteDelegate.create(
				parolePlan, description, secondDate);
		
		// Action
		parolePlanNote = this.parolePlanService.updateParolePlanNote(
				parolePlanNote, description, date);
	}
