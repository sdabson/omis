...
public class SecurityThreatGroupAffiliationServiceCreateTests
	...
	public void testCreate() throws DuplicateEntityFoundException {
		...
		// Action
		SecurityThreatGroupAffiliation securityThreatGroupAffiliation = 
				this.securityThreatGroupAffiliationService.create(offender, 
		...
		PropertyValueAsserter.create()
			...
			.performAssertions(securityThreatGroupAffiliation);
	}
	...
	public void testDuplicateEntityFoundException() 
		...
		// Action
		this.securityThreatGroupAffiliationService.create(offender, dateRange, 
				group, activityLevel, chapter, rank, state, city, moniker, 
				comment, verificationSignature);
