...
/**
 * Tests method to end a facility visit.
 *
 * @author Josh Divine
 * @version 0.0.1
 * @since OMIS 3.0
...
public class FacilityVisitationServiceEndVisitTests
	...
	/**
	 * Tests the ending of a facility visit.
	 * 
	 ...
	 */
	@Test
	public void testEndVisit() throws DuplicateEntityFoundException,
		...
		// Action
		visit = this.facilityVisitationService.endVisit(visit, 
				DateManipulator.getDateAtTimeOfDay(date, endTime));
	...
	public void testDateConflictException() 
		...
		Visit visit = this.visitDelegate.create(association, 
				...
				DateManipulator.getDateAtTimeOfDay(date, endTime), badgeNumber, 
				flags, notes, location);
		Date secondStartDate = this.parseDateText("01/06/2017");
		this.visitDelegate.create(association, 
				DateManipulator.getDateAtTimeOfDay(secondStartDate, startTime), 
				DateManipulator.getDateAtTimeOfDay(secondStartDate, endTime),
