...
/**
 * Probation Parole Document Service Create Tests.
 * 
 *@author Annie Wahl 
 ...
 */
@Test
public class ProbationParoleDocumentServiceCreateTests
	...
	public void testCreate()
		...
		ProbationParoleDocumentAssociation documentAssociation =
				...
				.createProbationParoleDocumentAssociation(document, offender, 
						date, category);
	...
	public void testDuplicateEntityFoundException()
		...
		ProbationParoleDocumentCategory category =
					...
					.create("Document Category", true);
		//create
		this.probationParoleDocumentAssociationDelegate.create(document,
					offender, date, category);
