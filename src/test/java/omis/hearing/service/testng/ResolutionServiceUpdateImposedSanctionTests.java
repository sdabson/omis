...
/**
 * Tests method to update imposed sanctions.
 *
 * @author Josh Divine
 ...
 */
@Test
public class ResolutionServiceUpdateImposedSanctionTests
	...
	@Autowired
	private ImposedSanctionDelegate imposedSanctionDelegate;
	...
	/**
	 * Test the update of imposed sanctions.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testUpdateImposedSanction() 
		...
		Infraction infraction = this.infractionDelegate.create(hearing, 
				conditionViolation, disciplinaryCodeViolation, resolution, plea);
		String description = "Description";
		ImposedSanction imposedSanction = this.imposedSanctionDelegate.create(
				infraction, offender, description);
		String newDescription = "New Description";

		// Action
		imposedSanction = this.resolutionService.updateImposedSanction(
				imposedSanction, offender, newDescription);

		// Assertions
		PropertyValueAsserter.create()
			.addExpectedValue("offender", offender)
			.addExpectedValue("description", newDescription)
			.performAssertions(imposedSanction);
	}
	...
	public void testDuplicateEntityFoundException() 
		...
		Infraction infraction = this.infractionDelegate.create(hearing, 
				conditionViolation, disciplinaryCodeViolation, resolution, plea);
		String description = "Description";
		this.imposedSanctionDelegate.create(infraction, offender, description);
		String newDescription = "New Description";
		ImposedSanction imposedSanction = this.imposedSanctionDelegate.create(
				infraction, offender, newDescription);
