...
/**
 * Tests method to create hearing notes.
 *
 * @author Josh Divine
 ...
 */
@Test
public class HearingServiceCreateHearingNoteTests
	...
	/**
	 * Tests the method to create hearing notes.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testCreateHearingNote() throws DuplicateEntityFoundException {
		// Arrangements
		...
		// Action
		HearingNote hearingNote = this.hearingService.createHearingNote(hearing, 
				description, date);
	...
	public void testDuplicateEntityFoundException() 
		...
		// Action
		this.hearingService.createHearingNote(hearing, description, date);
	}
