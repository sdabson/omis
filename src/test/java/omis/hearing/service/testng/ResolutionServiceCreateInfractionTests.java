 ...
 */
@Test
public class ResolutionServiceCreateInfractionTests
	...
	/**
	 * Tests the creation of infractions.
	 * 
	...
	public void testCreateInfraction() throws DuplicateEntityFoundException {
		...
		// Action
		Infraction infraction = this.resolutionService.createInfraction(hearing, 
	...
	public void testDuplicateEntityFoundException() 
		...
		// Action
		this.resolutionService.createInfraction(hearing, conditionViolation, 
				disciplinaryCodeViolation, resolution, plea);
	}
