 ...
 */
@Test
public class ResolutionServiceCreateHearingStatusTests
	...
	/**
	 * Tests the creation of hearing statuses.
	 * 
	...
	public void testCreateHearingStatus() throws DuplicateEntityFoundException {
		...
		// Action
		HearingStatus hearingStatus = this.resolutionService
	...
	public void testDuplicateEntityFoundException() 
		...
		// Action
		this.resolutionService.createHearingStatus(hearing, description, date, 
				category);
	}
