...
/**
 * Tests method to update user attendances.
 *
 * @author Josh Divine
 ...
 */
@Test
public class HearingServiceUpdateUserAttendanceTests
	...
	/**
	 * Test the update of the user account for a user attendance.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testUpdateUserAttendance() 
		...
		UserAccount userAccount = this.userAccountDelegate.create(attendee, 
				"U1", "", null, 0, true);
		UserAttendance userAttendance = this.userAttendanceDelegate.create(
				createHearing(), userAccount);
		Person newAttendee = this.personDelegate.create("Smith", "Johnny", "J", 
				null);
		UserAccount newUserAccount = this.userAccountDelegate.create(
				newAttendee, "U2", "", null, 0, true);

		// Action
		userAttendance = this.hearingService.updateUserAttendance(
				userAttendance, newUserAccount);

		// Assertions
		PropertyValueAsserter.create()
			.addExpectedValue("userAccount", newUserAccount)
	...
	public void testDuplicateEntityFoundException() 
		...
		UserAccount newUserAccount = this.userAccountDelegate.create(
				newAttendee, "U2", "", null, 0, true);
		UserAttendance userAttendance = this.userAttendanceDelegate.create(
				hearing, newUserAccount);
		// Action
		userAttendance = this.hearingService.updateUserAttendance(
				userAttendance, userAccount);
	}
