 ...
 */
@Test
public class ResolutionServiceUpdateHearingStatusTests
	...
	public void testUpdateHearingStatusDescription() 
		...
		// Action
		hearingStatus = this.resolutionService.updateHearingStatus(
				hearingStatus, newDescription, date, category);
	...
	public void testUpdateHearingStatusDate() 
		...
		// Action
		hearingStatus = this.resolutionService.updateHearingStatus(
				hearingStatus, description, newDate, category);
	...
	public void testUpdateHearingStatusCategory() 
		...
		// Action
		hearingStatus = this.resolutionService.updateHearingStatus(
				hearingStatus, description, date, newCategory);
	...
	public void testDuplicateEntityFoundException() 
		...
		// Action
		hearingStatus = this.resolutionService.updateHearingStatus(
				hearingStatus, description, date, category);
	}
