...
/**
 * Tests method to create imposed sanctions.
 *
 * @author Josh Divine
 ...
 */
@Test
public class ResolutionServiceCreateImposedSanctionTests
	...
	/**
	 * Tests the creation of imposed sanctions.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testCreateImposedSanction() 
		...
		PropertyValueAsserter.create()
			.addExpectedValue("infraction", infraction)
	...
	public void testDuplicateEntityFoundException() 
		...
		// Action
		this.resolutionService.createImposedSanction(infraction, offender, 
				description);
	}
