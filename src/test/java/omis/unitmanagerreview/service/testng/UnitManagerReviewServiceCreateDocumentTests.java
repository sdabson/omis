 ...
 */
@Test
public class UnitManagerReviewServiceCreateDocumentTests
	...
	public void testCreateDocument() throws DuplicateEntityFoundException {
		...
		// Action
		Document document = this.unitManagerReviewService.createDocument(date, 
	...
	public void testDuplicateEntityFoundException() 
		...
		// Action
		this.unitManagerReviewService.createDocument(date, title, filename, 
				fileExtension);
	}
