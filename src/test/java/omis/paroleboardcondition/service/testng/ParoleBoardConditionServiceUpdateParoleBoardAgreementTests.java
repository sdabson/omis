...
/**
 * Tests method to update parole board agreements.
 *
 * @author Josh Divine
 ...
 */
@Test
public class ParoleBoardConditionServiceUpdateParoleBoardAgreementTests
	...
	/**
	 * Tests the update of the category for a parole board agreement.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testUpdateParoleBoardAgreement() 
		...
		ParoleBoardAgreement paroleBoardAgreement = this
				.paroleBoardAgreementDelegate.create(agreement, boardHearing, 
						null, category);
		ParoleBoardAgreementCategory newCategory =
				this.paroleBoardAgreementCategoryDelegate
				.create("New Parole Category", true, false);

		// Action
		paroleBoardAgreement = this.paroleBoardConditionService
				.updateParoleBoardAgreement(paroleBoardAgreement, newCategory);
	...
	public void testDuplicateEntityFoundException() 
		...
		this.paroleBoardAgreementDelegate.create(agreement, boardHearing, null, 
				category);
		ParoleBoardAgreementCategory secondCategory =
				this.paroleBoardAgreementCategoryDelegate
				.create("Second Parole Category", true, false);
		ParoleBoardAgreement paroleBoardAgreement = this
				.paroleBoardAgreementDelegate.create(agreement, boardHearing, 
						null, secondCategory);
		...
		// Action
		paroleBoardAgreement = this.paroleBoardConditionService
				.updateParoleBoardAgreement(paroleBoardAgreement, category);
	}
