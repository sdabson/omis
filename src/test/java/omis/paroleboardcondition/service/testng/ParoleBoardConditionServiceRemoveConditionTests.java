...
/**
 * Tests method to remove conditions.
 *
 * @author Josh Divine
 * @version 0.0.1
 * @since OMIS 3.0
 */
@Test
public class ParoleBoardConditionServiceRemoveConditionTests
	...
	/**
	 * Tests the removal of conditions.
	 * 
	 * @throws DuplicateEntityFoundException if duplicate entity exists
	 */
	@Test
	public void testRemoveCondition() throws DuplicateEntityFoundException {
		// Arrangements
		...
		Condition condition = this.conditionDelegate.create(agreement, 
				"Santa Clause", conditionClause, ConditionCategory.STANDARD, 
				false);
