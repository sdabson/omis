...
/**
 * Tests method to create court cases from an existing docket.
 *
 * @author Josh Divine
 * @version 0.0.1
 * @since OMIS 3.0
 */
public class CourtCaseServiceCreateFromDocketTests
	...
	/**
	 * Tests the creation of court cases with an existing docket.
	 * 
	 ...
	 */
	@Test
	public void testCreateFromDocket() throws CourtCaseExistsException, 
		...
		// Action
		CourtCase courtCase = this.courtCaseService.createFromDocket(docket, 
				interStateNumber, interState, pronouncementDate, 
				jurisdictionAuthority, sentenceReviewDate, dangerDesignator, 
				chargeOffense, chargeDate, chargeFileDate, chargeCount, 
	...
	/**
	 * Tests {@code CourtCaseExistsException} is thrown.
	 * 
	 * @throws CourtCaseExistsException if court case already exists
	 * @throws DuplicateEntityFoundException if entity already exists
	 * @throws DocketExistsException if docket already exists
	...
	public void testCourtCaseExistsException() throws CourtCaseExistsException, 
			DuplicateEntityFoundException, DocketExistsException {
		// Arrangements
		Person person = this.personDelegate.create("Smith", "John", "Jay", 
				null);
		...
		CourtCaseFlags flags = new CourtCaseFlags(false, false, false, false);
		String comments = "Comments";
		this.courtCaseDelegate.create(docket, interStateNumber, interState, 
				pronouncementDate, jurisdictionAuthority, sentenceReviewDate, 
				dangerDesignator, personnel, flags, comments);

		// Action
		this.courtCaseService.createFromDocket(docket, interStateNumber, 
				interState, pronouncementDate, jurisdictionAuthority, 
				sentenceReviewDate, dangerDesignator, chargeOffense, chargeDate, 
				chargeFileDate, chargeCount, personnel, flags, comments);
	}
