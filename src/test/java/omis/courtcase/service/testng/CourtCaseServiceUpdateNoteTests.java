...
/**
 * Tests method to update court case notes.
 *
 * @author Josh Divine
 * @version 0.0.1
 * @since OMIS 3.0
 */
public class CourtCaseServiceUpdateNoteTests
	...
	/**
	 * Tests the update of the date for a court case note.
	 * 
	 ...
	 */
	@Test
	public void testUpdateNoteDate() throws CourtCaseNoteExistsException, 
		...
		String value = "Note";
		CourtCaseNote courtCaseNote = this.courtCaseNoteDelegate.addNote(
				courtCase, date, value);
		Date newDate = this.parseDateText("02/05/2017");
		
		// Action
		courtCaseNote = this.courtCaseService.updateNote(courtCaseNote, newDate, 
				value);
	...
	/**
	 * Tests the update of the value for a court case note.
	 * 
	 * @throws CourtCaseNoteExistsException if court case note already exists
	 * @throws DuplicateEntityFoundException if entity already exists
	 * @throws DocketExistsException if docket already exists
	 ...
	 */
	@Test
	public void testUpdateNoteValue() throws CourtCaseNoteExistsException, 
			DuplicateEntityFoundException, DocketExistsException,
			CourtCaseExistsException {
		// Arrangements
		Person person = this.personDelegate.create("Smith", "John", "Jay", 
		...
		// Action
		courtCaseNote = this.courtCaseService.updateNote(courtCaseNote, date, 
				newValue);
