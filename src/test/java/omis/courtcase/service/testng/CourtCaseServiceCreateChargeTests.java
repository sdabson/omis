 ...
 * @since OMIS 3.0
 */
public class CourtCaseServiceCreateChargeTests
	 ...
	 */
	@Test
	public void testCreateCharge() throws ChargeExistsException, 
		...
		// Action
		Charge charge = this.courtCaseService.createCharge(courtCase, offense, 
	...
	public void testChargeExistsException() throws ChargeExistsException, 
		...
		// Action
		this.courtCaseService.createCharge(courtCase, offense, date, fileDate, 
				counts);
	}
