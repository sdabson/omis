...
public class OffenderVehicleManagerFindColorsTests 
	...
	/**
	 * Test finding all vehicle colors
	 * @throws VehicleColorExistsException 
	 */
	@Test
	public void testFindingColors() throws VehicleColorExistsException {
		// Arrangements
		this.vehicleColorDelegate.create("ColorOne", true);
		this.vehicleColorDelegate.create("ColorTwo", true);
		
		// Action
		Integer count = this.offenderVehicleManager.findColors().size();
