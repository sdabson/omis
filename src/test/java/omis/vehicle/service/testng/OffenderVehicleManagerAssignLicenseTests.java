...
/**.
 * Test assigning vehicle license
 *
 * @author Yidong Li
...
public class OffenderVehicleManagerAssignLicenseTests 
	...
	public void testAssignLicense()
		...
		.addExpectedValue("vehicleAssociation", vehicleLicense.getVehicleAssociation())
		.addExpectedValue("plateNumber", vehicleLicense.getPlateNumber())
		.performAssertions(vehicleLicense);
	}
