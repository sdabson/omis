...
/**
 * Vehicle owner remove tests.
 * 
 * @author Yidong Li
 * @version 0.1.0 (Dec 20, 2018)
 * @since OMIS 3.0
 */
public class OffenderVehicleManagerRemoveOwnerTests
extends AbstractHibernateTransactionalTestNGSpringContextTests {
	/* Data access objects. */
	@Autowired
	@Qualifier("vehicleOwnerAssociationDao")
	private VehicleOwnerAssociationDao vehicleOwnerAssociationDao;
	...
	/**
	 * Instantiates an vehicle owner association remove tests.
	 */
	public OffenderVehicleManagerRemoveOwnerTests() {
		//Default constructor.
	}
	
	/**
	 * Tests the removal of a vehicle owner association
	 * @throws VehicleAssociationExistsException 
	 */
	@Test
	public void testRemoveOwner() throws VehicleAssociationExistsException {
		// Arrangement
		...
		//Action
		this.offenderVehicleManager.removeOwner(vehicleOwnerAssociation);
		
		//Assertion
		assert vehicleOwnerAssociation.equals(this.vehicleOwnerAssociationDao
			.findOwnerByVehicleAssociation(vehicleAssociation))
			: "Vehicle owner has not been removed.";
	}
