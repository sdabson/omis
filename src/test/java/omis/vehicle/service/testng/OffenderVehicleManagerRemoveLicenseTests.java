...
/**
 * Vehicle license remove tests.
 * 
 * @author Yidong Li
 * @version 0.1.0 (Dec 20, 2018)
 * @since OMIS 3.0
 */
public class OffenderVehicleManagerRemoveLicenseTests
extends AbstractHibernateTransactionalTestNGSpringContextTests {
	/* Data access objects. */
	@Autowired
	@Qualifier("vehicleLicenseDao")
	...
	/**
	 * Instantiates an vehicle association service license remove tests.
	 */
	public OffenderVehicleManagerRemoveLicenseTests() {
		//Default constructor.
	}
	
	/**
	 * Tests the removal of a vehicle license.
	 * @throws VehicleAssociationExistsException 
	 */
	@Test
	public void testRemoveLicense() throws VehicleAssociationExistsException {
	// Arrangement
	...
	VehicleLicense vehicleLicense = this.offenderVehicleManager
		.assignLicense(vehicleAssociation, "123456789", state);
			
	//Action
	this.offenderVehicleManager.removeLicense(vehicleLicense);
	
	//Assertion
	assert this.vehicleLicenseDao.findLicenseByVehicleAssociation(
		vehicleAssociation).equals(vehicleLicense)
		: "Vehicle license has not been removed.";
	}
