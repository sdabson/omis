...
/**
 * Tests method to update associate separation needs and separation need reasons.
 *
 * @author Josh Divine
 * @version 0.0.1
 * @since OMIS 3.0
 */
public class SeparationNeedServiceUpdateAssociatedReasonTests
	...
	/**
	 * Test the update of the reason for a separation need reason association.
	 * 
	 ...
	 */
	@Test
	public void testUpdateAssociatedReason() 
		...
		SeparationNeedReason reason = this.separationNeedReasonDelegate.create(
				"Reason", true);
		SeparationNeedReasonAssociation association = this
				.separationNeedReasonAssociationDelegate.create(separationNeed, 
				reason);
		SeparationNeedReason newReason = this.separationNeedReasonDelegate
				.create("New Reason", true);
		// Action
		association = this.separationNeedService.updateAssociatedReason(
				association, newReason);
	...
	public void testDuplicateEntityFoundException() 
		...
		this.separationNeedReasonAssociationDelegate.create(separationNeed, 
				reason);
		SeparationNeedReason secondReason = this.separationNeedReasonDelegate
				.create("New Reason", true);
		SeparationNeedReasonAssociation association = this
				.separationNeedReasonAssociationDelegate.create(separationNeed, 
				secondReason);
